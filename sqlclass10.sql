USE mysqllabs;
CREATE TABLE students5 (`student_id` INT(3) NOT NULL , `name` VARCHAR(50) NOT NULL , `email` VARCHAR(100) NOT NULL,UNIQUE (student_id,email));
SELECT * FROM students5;

CREATE TABLE courses5 (`course_id` INT(3) NOT NULL , `course_name` VARCHAR(50) NOT NULL ,UNIQUE (course_id));
